...
import ClassSelClassRecord from '../pages/ClassSelClassRecord.vue'
...
const routes = [
  ...
  { path: '/class/selClassRecord', component: ClassSelClassRecord, meta: { requiresAuth: true, role: 'admin' } },
